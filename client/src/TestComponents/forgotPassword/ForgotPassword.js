...
const ForgotPassword = ({ setShowProgress }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (emailIsValid(email)) {
      try {
<<<<<<< HEAD:client/src/Components/ForgotPassword/ForgotPassword.js
        const res = await fetch(`${process.env.REACT_APP_SERVER_DOMAIN}/api/user/forgot-password`, {
=======
        const res = await fetch('/api/user/forgot-password', {
>>>>>>> 5893ac4152f0f0f9dcd8cb42ceaac17ff47421e3:client/src/TestComponents/forgotPassword/ForgotPassword.js
          method: 'POST',
